...
def ai(list_all):
    ...
    search_count = 0
    negamax(True, DEPTH, -99999999, 99999999,list_all,next_point)
...
def negamax(is_ai, depth, alpha, beta,list_all,next_point):
    ...
    order(blank_list,list_all)   # 搜索顺序排序  提高剪枝效率
    # 遍历每一个候选步
    for next_step in blank_list:
        ...
        if not has_neightnor(next_step,list_all):
            continue
...
# 评估函数
def evaluation(is_ai,list_my,list_enemy):
    total_score = 0
